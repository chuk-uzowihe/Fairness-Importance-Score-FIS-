...
def single_stn(elements_per_group,iterations,stn1):
    ...
    return eqop_mean,dp_mean,feature_mean
...
#%%
dp_11, eq_11, f_11 = single_stn(3,5,stn1_1)
dp_12, eq_12, f_12 = single_stn(3,5,stn1_2)
dp_13, eq_13, f_13 = single_stn(3,5,stn1_3)
dp_14, eq_14, f_14 = single_stn(3,5,stn1_4)


dp_21, eq_21, f_21 = single_stn(3,5,stn2_1)
dp_22, eq_22, f_22 = single_stn(3,5,stn2_2)
dp_23, eq_23, f_23 = single_stn(3,5,stn2_3)
dp_24, eq_24, f_24 = single_stn(3,5,stn2_4)

dp_31, eq_31, f_31 = single_stn(3,5,stn3_1)
dp_32, eq_32, f_32 = single_stn(3,5,stn3_2)
dp_33, eq_33, f_33 = single_stn(3,5,stn3_3)
dp_34, eq_34, f_34 = single_stn(3,5,stn3_4)

dp_41, eq_41, f_41 = single_stn(3,5,stn4_1)
dp_42, eq_42, f_42 = single_stn(3,5,stn4_2)
dp_43, eq_43, f_43 = single_stn(3,5,stn4_3)
dp_44, eq_44, f_44 = single_stn(3,5,stn4_4)
#%%
...
plt.legend(handles = [patch1,patch2,patch3,patch4,patch5,patch6],loc=2, bbox_to_anchor=(1.05,4))
plt.tight_layout()
plt.savefig("lin_eqop.pdf")
