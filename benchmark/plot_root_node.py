...
def single_stn(stn):
   dp_values = {}
   eq_values = {}
   [dp_values.setdefault(i, []) for i in range(12)]
   [eq_values.setdefault(i, []) for i in range(12)]
   for i in range(len(stn)):
      feature = stn['feature_root'].iloc[i]
      dp_values[feature].append(stn['fis_root_dp'].iloc[i])
      eq_values[feature].append(stn['fis_root_eqop'].iloc[i])
...
#%%
stn1 = pd.read_csv("result100_3_0.55tree_root.csv")
stn2 = pd.read_csv("result100_3_1.25tree_root.csv")
stn3 = pd.read_csv("result100_3_1.8tree_root.csv")


#%%
stn1_10 = pd.read_csv("result500_3_0.55tree_root.csv")
stn2_10 = pd.read_csv("result500_3_1.25tree_root.csv")
stn3_10 = pd.read_csv("result500_3_1.8tree_root.csv")

stn1_15 = pd.read_csv("result1000_3_0.55tree_root.csv")
stn2_15 = pd.read_csv("result1000_3_1.25tree_root.csv")
stn3_15 = pd.read_csv("result1000_3_1.8tree_root.csv")
...
fig.supylabel("E[fairness(EQOP)]", fontsize = 20)
