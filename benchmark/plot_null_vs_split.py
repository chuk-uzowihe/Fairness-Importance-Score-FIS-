...
#%%
def single_stn(total_features,iterations,stn,stn1):
    ...
    for i in range(iterations):
        for j in range(total_features):
            ...
            dp_root_values[j].append(stn1['fis_dp'].iloc[i*elements_per_group*4 + j])
...
#%%
stn1 = pd.read_csv("boosting100_3_0.55binom.csv")
stn2 = pd.read_csv("boosting100_3_1.25binom.csv")
stn3 = pd.read_csv("boosting100_3_1.8binom.csv")

stn1_10 = pd.read_csv("boosting500_3_0.55binom.csv")
stn2_10 = pd.read_csv("boosting500_3_1.25binom.csv")
stn3_10 = pd.read_csv("boosting500_3_1.8binom.csv")

stn1_15 = pd.read_csv("boosting1000_3_0.55binom.csv")
stn2_15 = pd.read_csv("boosting1000_3_1.25binom.csv")
stn3_15 = pd.read_csv("boosting1000_3_1.8binom.csv")


#%%
stn1_null = pd.read_csv("boosting100_3_0.55.csv")
stn2_null = pd.read_csv("boosting100_3_1.25.csv")
stn3_null = pd.read_csv("boosting100_3_1.8.csv")

stn1_10_null = pd.read_csv("boosting500_3_0.55.csv")
stn2_10_null = pd.read_csv("boosting500_3_1.25.csv")
stn3_10_null = pd.read_csv("boosting500_3_1.8.csv")

stn1_15_null = pd.read_csv("boosting1000_3_0.55.csv")
stn2_15_null = pd.read_csv("boosting1000_3_1.25.csv")
stn3_15_null = pd.read_csv("boosting1000_3_1.8.csv")
#%%
dp_m1, dp_e1,dp_root_m1,dp_root_e1, eq_m1,eq_e1, eq_root_m1,eq_root_e1 =single_stn(12,10,stn1,stn1_null)
dp_m2, dp_e2,dp_root_m2,dp_root_e2, eq_m2,eq_e2, eq_root_m2,eq_root_e2 = single_stn(12,10,stn2,stn2_null)
dp_m3, dp_e3,dp_root_m3,dp_root_e3, eq_m3,eq_e3, eq_root_m3,eq_root_e3 = single_stn(12,10,stn3,stn3_null)


dp_m1_10, dp_e1_10,dp_root_m1_10,dp_root_e1_10, eq_m1_10,eq_e1_10, eq_root_m1_10,eq_root_e1_10 =single_stn(12,10,stn1_10,stn1_10_null)
dp_m2_10, dp_e2_10,dp_root_m2_10,dp_root_e2_10, eq_m2_10,eq_e2_10, eq_root_m2_10,eq_root_e2_10 = single_stn(12,10,stn2_10,stn2_10_null)
dp_m3_10, dp_e3_10,dp_root_m3_10,dp_root_e3_10, eq_m3_10,eq_e3_10, eq_root_m3_10,eq_root_e3_10 = single_stn(12,10,stn3_10,stn3_10_null)


dp_m1_15, dp_e1_15,dp_root_m1_15,dp_root_e1_15, eq_m1_15,eq_e1_15, eq_root_m1_15,eq_root_e1_15 =single_stn(12,10,stn1_15,stn1_15_null)
dp_m2_15, dp_e2_15,dp_root_m2_15,dp_root_e2_15, eq_m2_15,eq_e2_15, eq_root_m2_15,eq_root_e2_15 = single_stn(12,10,stn2_15,stn2_15_null)
dp_m3_15, dp_e3_15,dp_root_m3_15,dp_root_e3_15, eq_m3_15,eq_e3_15, eq_root_m3_15,eq_root_e3_15 = single_stn(12,10,stn3_15,stn3_15_null)
...
ax[0,0].bar(np.arange(1,elements_per_group+1)-width,eq_m1[0:elements_per_group],yerr = eq_e1[0:elements_per_group],width = width, color = 'r', label = "Group 1 (z & y) new")
ax[0,0].bar(np.arange(elements_per_group+1,elements_per_group*2+1)-width,eq_m1[elements_per_group:elements_per_group*2],yerr = eq_e1[elements_per_group:elements_per_group*2],width = width, color = 'g', label = "Group 2 (z) new")
ax[0,0].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1)-width,eq_m1[elements_per_group*2:elements_per_group*3],yerr = eq_e1[elements_per_group*2:elements_per_group*3],width = width, color = 'y', label = "Group 3 (y) new")
ax[0,0].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1)-width,eq_m1[elements_per_group*3:elements_per_group*4],yerr = eq_e1[elements_per_group*3:elements_per_group*4],width = width, color = 'c', label = "Group 4 (-) new")

ax[0,0].bar(np.arange(1,elements_per_group+1)+width,eq_root_m1[0:elements_per_group],yerr = eq_root_e1[0:elements_per_group],width = width, color = 'r',hatch='//', label = "Group 1 (z & y) old")
ax[0,0].bar(np.arange(elements_per_group+1,elements_per_group*2+1)+width,eq_root_m1[elements_per_group:elements_per_group*2],yerr = eq_root_e1[elements_per_group:elements_per_group*2],width = width, color = 'g',hatch='//', label = "Group 2 (z) old")
ax[0,0].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1)+width,eq_root_m1[elements_per_group*2:elements_per_group*3],yerr = eq_root_e1[elements_per_group*2:elements_per_group*3],width = width, color = 'y',hatch='//', label = "Group 3 (y) old")
ax[0,0].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1)+width,eq_root_m1[elements_per_group*3:elements_per_group*4],yerr = eq_root_e1[elements_per_group*3:elements_per_group*4],width = width, color = 'c',hatch='//', label = "Group 4 (-) old")
...
plt.savefig("eq_new_boosting.pdf")

# %%
stn1 = pd.read_csv("rndm_nonlin100_4_0.3rf_2.csv")
stn2 = pd.read_csv("rndm_nonlin100_4_0.62rf_2.csv")
stn3 = pd.read_csv("rndm_nonlin100_4_0.9rf_2.csv")

stn1_10 = pd.read_csv("rndm_nonlin500_4_0.3rf_2.csv")
stn2_10 = pd.read_csv("rndm_nonlin500_4_0.62rf_2.csv")
stn3_10 = pd.read_csv("rndm_nonlin500_4_0.9rf_2.csv")

stn1_15 = pd.read_csv("rndm_nonlin1000_4_0.3rf_2.csv")
stn2_15 = pd.read_csv("rndm_nonlin1000_4_0.62rf_2.csv")
stn3_15 = pd.read_csv("rndm_nonlin1000_4_0.9rf_2.csv")


#%%
stn1_null = pd.read_csv("rndm_nonlin100_4_0.3rf_2null.csv")
stn2_null = pd.read_csv("rndm_nonlin100_4_0.62rf_2null.csv")
stn3_null = pd.read_csv("rndm_nonlin100_4_0.9rf_2null.csv")

stn1_10_null = pd.read_csv("rndm_nonlin500_4_0.3rf_2null.csv")
stn2_10_null = pd.read_csv("rndm_nonlin500_4_0.62rf_2null.csv")
stn3_10_null = pd.read_csv("rndm_nonlin500_4_0.9rf_2null.csv")

stn1_15_null = pd.read_csv("rndm_nonlin1000_4_0.3rf_2null.csv")
stn2_15_null = pd.read_csv("rndm_nonlin1000_4_0.62rf_2null.csv")
stn3_15_null = pd.read_csv("rndm_nonlin1000_4_0.9rf_2null.csv")