...
#%%
stn1 = pd.read_csv("boosting_rndm100_3_1.csv")
stn2 = pd.read_csv("boosting_rndm100_3_2.csv")
stn3 = pd.read_csv("boosting_rndm100_3_3.csv")

stn1_10 = pd.read_csv("boosting_rndm500_3_1.csv")
stn2_10 = pd.read_csv("boosting_rndm500_3_2.csv")
stn3_10 = pd.read_csv("boosting_rndm500_3_3.csv")

stn1_15 = pd.read_csv("boosting_rndm1000_3_1.csv")
stn2_15 = pd.read_csv("boosting_rndm1000_3_2.csv")
stn3_15 = pd.read_csv("boosting_rndm1000_3_3.csv")
#%%
...
ax[0,0].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m1[elements_per_group*2:elements_per_group*3],yerr = eq_e1[elements_per_group*2:elements_per_group*3],width = width, color = 'y', label = "Group 3 (y)")
ax[0,0].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m1[elements_per_group*3:elements_per_group*4],yerr = eq_e1[elements_per_group*3:elements_per_group*4],width = width, color = 'c', label = "Group 4 (-)")
...
ax[0,1].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m2[elements_per_group*2:elements_per_group*3],yerr = eq_e2[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[0,1].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m2[elements_per_group*3:elements_per_group*4],yerr = eq_e2[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
...
ax[0,2].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m3[elements_per_group*2:elements_per_group*3],yerr = eq_e3[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[0,2].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m3[elements_per_group*3:elements_per_group*4],yerr = eq_e3[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
...
ax[1,0].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m1_10[elements_per_group*2:elements_per_group*3],yerr = eq_e1_10[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[1,0].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m1_10[elements_per_group*3:elements_per_group*4],yerr = eq_e1_10[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
#ax[0,0].bar(x_axis,occd_m1,yerr = occd_e1,width = width, color = 'b', label = "OFS")
...
ax[1,1].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m2_10[elements_per_group*2:elements_per_group*3],yerr = eq_e2_10[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[1,1].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m2_10[elements_per_group*3:elements_per_group*4],yerr = eq_e2_10[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
#ax[0,1].bar(x_axis,occd_m2,yerr = occd_e2,width = width, color = 'b', label = "OFS")
...
ax[1,2].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m3_10[elements_per_group*2:elements_per_group*3],yerr = eq_e3_10[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[1,2].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m3_10[elements_per_group*3:elements_per_group*4],yerr = eq_e3_10[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
#ax[1,0].bar(x_axis,occd_m3,yerr = occd_e3,width = width, color = 'b', label = "OFS")
...
ax[2,0].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m1_15[elements_per_group*2:elements_per_group*3],yerr = eq_e1_15[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[2,0].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m1_15[elements_per_group*3:elements_per_group*4],yerr = eq_e1_15[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
#ax[0,0].bar(x_axis,occd_m1,yerr = occd_e1,width = width, color = 'b', label = "OFS")
...
ax[2,1].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m2_15[elements_per_group*2:elements_per_group*3],yerr = eq_e2_15[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[2,1].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m2_15[elements_per_group*3:elements_per_group*4],yerr = eq_e2_15[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
#ax[0,1].bar(x_axis,occd_m2,yerr = occd_e2,width = width, color = 'b', label = "OFS")
...
ax[2,2].bar(np.arange(elements_per_group*2+1,elements_per_group*3+1),eq_m3_15[elements_per_group*2:elements_per_group*3],yerr = eq_e3_15[elements_per_group*2:elements_per_group*3],width = width, color = 'y')
ax[2,2].bar(np.arange(elements_per_group*3+1,elements_per_group*4+1),eq_m3_15[elements_per_group*3:elements_per_group*4],yerr = eq_e3_15[elements_per_group*3:elements_per_group*4],width = width, color = 'c')
#ax[1,0].bar(x_axis,occd_m3,yerr = occd_e3,width = width, color = 'b', label = "OFS")
...
plt.savefig("dp_rndm_boost_1.pdf")
