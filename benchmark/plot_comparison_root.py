...
#%%
def single_stn(total_features,iterations,stn1):
    ...
    for i in range(iterations):
        for j in range(total_features):
            dp_values[j].append(stn1['dp'].iloc[i*elements_per_group*4 + j])
            eq_values[j].append(stn1['eqop'].iloc[i*elements_per_group*4 + j])
            dp_root_values[j].append(stn1['dp_root'].iloc[i*elements_per_group*4 + j])
            eq_root_values[j].append(stn1['eqop_root'].iloc[i*elements_per_group*4 + j])
...
#%%
stn1 = pd.read_csv("onedp_eq100_0.55.csv")
stn2 = pd.read_csv("onedp_eq100_1.25.csv")
stn3 = pd.read_csv("onedp_eq100_1.8.csv")

stn1_10 = pd.read_csv("onedp_eq500_0.55.csv")
stn2_10 = pd.read_csv("onedp_eq500_1.25.csv")
stn3_10 = pd.read_csv("onedp_eq500_1.8.csv")

stn1_15 = pd.read_csv("onedp_eq1000_0.55.csv")
stn2_15 = pd.read_csv("onedp_eq1000_1.25.csv")
stn3_15 = pd.read_csv("onedp_eq1000_1.8.csv")
#%%
