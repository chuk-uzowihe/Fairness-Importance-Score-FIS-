...
def single_stn_result(elements_per_group,iterations,stn1):
    ...
    return eqop_mean, eqop_err, dp_mean, dp_err,  occ_dp_mean, occ_dp_err, occ_eqop_mean, occ_eqop_err
...
width = 0.5
stn1 = pd.read_csv("result500_3_0.55boosting_stump.csv")
stn2 = pd.read_csv("result500_3_1.25boosting_stump.csv")
stn3 = pd.read_csv("result500_3_1.8boosting_stump.csv")
...
stn1_10 = pd.read_csv("result1000_3_0.55boosting_stump.csv")
stn2_10 = pd.read_csv("result1000_3_1.25boosting_stump.csv")
stn3_10 = pd.read_csv("result1000_3_1.8boosting_stump.csv")
#stn4 = pd.read_csv("result_3_0.882.csv")
...
stn1_15 = pd.read_csv("result1500_3_0.55boosting_stump.csv")
stn2_15 = pd.read_csv("result1500_3_1.25boosting_stump.csv")
stn3_15 = pd.read_csv("result1500_3_1.8boosting_stump.csv")
#stn4 = pd.read_csv("result_3_0.882.csv")
...
plt.savefig("toy_dp_boosting_stump.pdf")
# %%
